export default function Table() {
    ...
    return (
      <>
        <h3 className="text-dark">Posts by <span className="text-warning">Location</span></h3>
        <table className="table table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" className="bi bi-1-square-fill" viewBox="0 0 16 16">
            ...
            <tr>
              ...
              <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" className="bi bi-2-square-fill" viewBox="0 0 16 16">
